 ...
 * TODO The test should fail because you need to make some changes to the IOUState to make the test pass. Read the
...
class IOUStateTests {
    ...
    /**
     * Task 2.
     * TODO: Add a 'lender' property of type [Party] to the [IOUState] class to get this test to pass. - Done
     */
    @Test
